...
<body>
	...
	<table>
		<tr>
			...
			<!-- DDDDDDDDDDDDDDDDDDoooooooooooooooooooooowwwwwwwwwwwwwwwwwwwwwwwwwnnnnnnnnnnnnnnnnnnnnn -->
  ...
  var dims = {
	...
	<table>
		...
		<tr>
			<th><img
				src="http://localhost:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=texas:airports_points_gcs& legend_options=forceLabels:on">
			</th>
		...
		<tr>
			<th><img
				src="http://localhost:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=texas:texas_roads_gcs">
			</th>

		</tr>
		<tr>
			<th><img
				src="http://localhost:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=texas:texas_rivers">
			</th>

		</tr>
	</table>
           <table  bgcolor="#9999ff">
                <tr><h2>Query Builder</h2></tr>
                <tr><th>
                     Field 
                    <select onchange="sendInfo()" id = "dd_1" size="5">                         
                     ...
                     <th><button onclick="buttonclicked(this.value)" id="equ" class="operator" value=" = " style="visibility:hidden">=</button>
                        <button onclick="buttonclicked(this.value)" id="notequ" value=" != "  style="visibility:hidden">!=</button>
                       <button onclick="buttonclicked(this.value)" id="pbutton" value ="Population"  style="visibility:hidden">Population</button> 
                     </th>
                     
                       
                    <th style="visibility:hidden" id="ddlist2">
                         Value
                        <select onchange="dd_2changed()" id="dd_2" size="6" visible="false">

                        </select>
                    </th>
                     
                </tr>
                <tr><td></td> <td align="center"><button onclick ="buttonclicked(this.value)" value=" AND " style = "visibility:hidden" id="andbutton">AND</button></td><td></td></tr>
                ...
                <tr><th></th><th id="pgroup" style="visibility:hidden"><button onclick="buttonclicked(this.value)" value=" <= "><=</button><button onclick="buttonclicked(this.value)" value=" >= " >>=</button><button onclick="buttonclicked(this.value)" value="Both">Both</button></th><th></th></tr>
                <tr><td align="right">Query</td><td><textarea cols="50" rows="5" id="textbox"></textarea></td></tr>    
                <tr align="center"><td align="center"><button value="reset" onclick="resetQueryBuilder()">Reset</button></td>
                                    <td align="center"><button value="submit" id="submit" onclick="executeQuery()" disabled="true">Submit</button></td>
                </tr>
		<script src="QueryBuilder.js"></script>	 
		</table>	 
	<form method="get">
		<input type="radio" id="populationRadiobutton" value="Population"
			onclick="pupulationFunction()">Population<br> <input
			type="checkbox" id="AirportCheckbox" value="Airport">Airports<br>
		<input type="checkbox" id="RoadsCheckbox" value="Roads">Roads<br>
		<input type="checkbox" id="RiverCheckbox">Rivers<br> <input
			type="button" onclick="checkBoxChanged()" value="Get layer" />
